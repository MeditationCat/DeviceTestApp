...
public class AutoTest extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (DeviceTestApp.IsFactoryMode) {
            intent.setClassName(this, "com.zhi_tech.devicetestapp.sensor.GSensor");
            this.startActivityForResult(intent, AppDefine.DT_GSENSORID);
        } else {
            intent.setClassName(this, "com.zhi_tech.devicetestapp.KeyCode");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (DeviceTestApp.IsFactoryMode) {
            if (requestCode == AppDefine.DT_GSENSORID) {
                ...
                intent.setClassName(this, "com.zhi_tech.devicetestapp.sensor.MSensor");
        ...
        if (requestCode == AppDefine.DT_MSENSORID) {
            if (DeviceTestApp.IsFactoryMode) {
                ...
                intent.setClassName(this, "com.zhi_tech.devicetestapp.sensor.GyRoscopeSensor");
            } else {
                intent.setClassName(this, "com.zhi_tech.devicetestapp.sensor.LSensor");
                requestid = AppDefine.DT_LSENSORID;
            }
        }
        if (requestCode == AppDefine.DT_LSENSORID) {
            intent.setClassName(this, "com.zhi_tech.devicetestapp.sensor.PSensor");
        ...
        if (requestCode == AppDefine.DT_GYROSCOPESENSORID) {
            intent.setClassName(this, "com.zhi_tech.devicetestapp.sensor.TSensor");
        ...
        /*if (requestCode == AppDefine.DT_TSENSORID) {
            intent.setClassName(this, "com.zhi_tech.devicetestapp.bluetooth.Bluetooth");

...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class SettingPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference("light_threshold_approach"));
            bindPreferenceSummaryToValue(findPreference("temp_range_min"));
            bindPreferenceSummaryToValue(findPreference("temp_range_max"));
            bindPreferenceSummaryToValue(findPreference("magnetic_yaw_offset"));
        }
